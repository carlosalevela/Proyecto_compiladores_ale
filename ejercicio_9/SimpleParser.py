...
def serializedATN():
    return [
        4,1,15,72,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,1,0,4,0,12,8,0,
        ...
        1,4,1,4,1,4,3,4,61,8,4,1,4,1,4,1,4,1,4,5,4,67,8,4,10,4,12,4,70,9,
        4,1,4,0,1,8,5,0,2,4,6,8,0,2,1,0,9,10,1,0,11,12,75,0,11,1,0,0,0,2,
        15,1,0,0,0,4,37,1,0,0,0,6,47,1,0,0,0,8,60,1,0,0,0,10,12,3,2,1,0,
        11,10,1,0,0,0,12,13,1,0,0,0,13,11,1,0,0,0,13,14,1,0,0,0,14,1,1,0,
        0,0,15,16,5,1,0,0,16,17,5,14,0,0,17,19,5,2,0,0,18,20,3,4,2,0,19,
        18,1,0,0,0,20,21,1,0,0,0,21,19,1,0,0,0,21,22,1,0,0,0,22,23,1,0,0,
        0,23,24,5,3,0,0,24,3,1,0,0,0,25,26,5,4,0,0,26,27,5,14,0,0,27,38,
        5,5,0,0,28,29,5,4,0,0,29,30,5,14,0,0,30,31,5,6,0,0,31,32,5,14,0,
        0,32,33,5,7,0,0,33,34,5,2,0,0,34,35,3,6,3,0,35,36,5,3,0,0,36,38,
        1,0,0,0,37,25,1,0,0,0,37,28,1,0,0,0,38,5,1,0,0,0,39,40,3,8,4,0,40,
        41,5,5,0,0,41,48,1,0,0,0,42,43,5,14,0,0,43,44,5,8,0,0,44,45,3,8,
        4,0,45,46,5,5,0,0,46,48,1,0,0,0,47,39,1,0,0,0,47,42,1,0,0,0,48,7,
        1,0,0,0,49,50,6,4,-1,0,50,61,5,13,0,0,51,52,5,14,0,0,52,53,5,6,0,
        0,53,54,5,13,0,0,54,61,5,7,0,0,55,61,5,14,0,0,56,57,5,6,0,0,57,58,
        3,8,4,0,58,59,5,7,0,0,59,61,1,0,0,0,60,49,1,0,0,0,60,51,1,0,0,0,
        60,55,1,0,0,0,60,56,1,0,0,0,61,68,1,0,0,0,62,63,10,6,0,0,63,67,7,
        0,0,0,64,65,10,5,0,0,65,67,7,1,0,0,66,62,1,0,0,0,66,64,1,0,0,0,67,
        70,1,0,0,0,68,66,1,0,0,0,68,69,1,0,0,0,69,9,1,0,0,0,70,68,1,0,0,
        0,7,13,21,37,47,60,66,68
    ]
...
class SimpleParser ( Parser ):
    ...
    class MultiDivContext(ExprContext):
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = SimpleParser.SumaRestaContext(self, SimpleParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = SimpleParser.MultiDivContext(self, SimpleParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 64
